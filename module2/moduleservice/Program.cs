  ...
  class Program
  {
    static int Main()
    {
      var exitCode = HostFactory.Run(host =>
      {
        ...
        host.SetDisplayName("Microservices Example Module 2");
        host.SetServiceName("module1service");
        host.SetDescription("Local service to implement service endpoints for Microservices Example Module2 for DDD Scotland presentation");
