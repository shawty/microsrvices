  ...
  class Program
  {
    static int Main()
    {
      var exitCode = HostFactory.Run(host =>
      {
        ...
        host.SetDisplayName("Microservices Example Module 3");
        host.SetServiceName("module1service");
        host.SetDescription("Local service to implement service endpoints for Microservices Example Module3 for DDD Scotland presentation");
